...
global.auto_react = false // හැම මැසේජ් එකකටම රියැක්ට් වෙන්න ඕන නම් true, නැත්නම් false
global.react_emojis = ['❤️', '🩵', '🦄', '👻', '🧚', '💐', '🪄', '⭐', '🅰️', '🇱🇰'] // රියැක්ට් වෙන්න ඕන ඉමෝජි ටික මෙතනට දාන්න
global.antidelete = true; // Anti-delete වැඩ කරන්න ඕන නම් true, එපා නම් false කරන්න.
...
global.APIs = {
	Avi: 'https://api.Avi.pw',
}
global.APIKeys = {
	'https://api.Avi.pw': 'htrkey-77eb83c0eeb39d40',
	geminiApikey: ['AIzaSyBhwdYed0MC-G64vDIC7ehw7YOxqLnmNzk','AIzaSyDnBPd_EhBfr73NssnThVQZYiKZVhGZewU','AIzaSyA94OZD-0V4quRbzPb2j75AuzSblPHE75M','AIzaSyB5aTYbUg2VQ0oXr5hdJPN8AyLJcmM84-A','AIzaSyB1xYZ2YImnBdi2Bh-If_8lj6rvSkabqlA']
}
